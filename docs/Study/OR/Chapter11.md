...
- 建立每个厂商的利润函数。每个厂商的利润函数可以表示为其产量乘以市场价格减去其生产成本，即：$πi(q_1, q_2, ..., q_n) = qi(P(q_1, q_2, ..., q_n)) - c_i(q_i)$,其中，$i$表示第$i$个厂商，$qi$表示其产量，$P(q_1, q_2, ..., q_n)$表示市场价格，$c_i(q_i)$表示第$i$个厂商的生产成本。
