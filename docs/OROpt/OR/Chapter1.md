...
!!! quote "**线性规划**（Linear Program）：是在线形约束下求解线性目标函数最优值的数学理论和方法。"
    本页面更多针对一些完全没有基础的人群，因此它的描述、用词、数学表示都略显稚嫩，如果你不属于这个集合，建议按需选择下一步浏览的笔记：

    - 对于<u>偏好学术、想要复习LP、适合有相关基础人群</u>，最佳的 LP 与 Simplex Method 笔记，请参考[离散优化：线性规划、单纯形法与进阶](../DiscreteOpt/Ch_03.md)。包含极点表示定理、 Farkas 引理、对偶理论、矩阵表示等；
    - 对于<u>入门级</u>、重在寻找与对偶理论之间神秘关系的<u>做题向人群</u>，请参考 [对偶问题的做题向写法](./Chapter3_ext1.md)：这份笔记不具有太强的指导意义；
    - 对于想要<u>快速复习凸优化及其基础理论的有基础人群</u>，请参考[最优化基础](./Chapter5_1.md)，包含范数基础、仿射、凸性、锥等。
